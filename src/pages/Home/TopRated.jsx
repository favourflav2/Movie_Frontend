...
import { useTopRatedQuery } from "../../Redux/api/movieApi";
...
export default function TopRated() {
  ...
  const { data, isFetching, error } = useTopRatedQuery(1);
  ...
  return (
    <Box name="rated" className=" sm:h-[670px] h-[580px] sm:my-[100px] flex flex-col ">
      <Typography className="text-2xl mb-1 underline ">Top Rated</Typography>
      ...
      <Typography className="text-[19px] p-2 flex cursor-pointer transition ease-in-out delay-150 hover:-translate-y-[2px] underline justify-end duration-300  hover:text-indigo-500">
        <Link to={`/allCategories/Top Rated`}>See All</Link>
      </Typography>
